    ...
    <div class="container u-full-width u-max-full-width">
        ...
        <div class="row">
            <div class="twelve columns" style="background-color: black;">
                <img src="./images/ftbg.jpg" alt="" id="lmbg">
                <h2 style="text-align: center; color:crimson;">Festivals</h2>
            </div>
        </div>
        <?php
            $file = simplexml_load_file("Danao-Jimenez-Zoleta_IT2E_Baguio.xml");

            foreach($file->festivals->festival as $ft){
                echo "
                <div class='row cont'>
                <div class='five columns'>
                    <img src='$ft->image' class='fimage'>
                </div>
