...
<head>
    ...
    <title>Baguio | Mountains</title>
</head>
<body>
    <div class="container u-full-width u-max-full-width">
        <div class="row tcenter">
            <div class="two columns">
                <h4><a href="./landmark.php">Mountains</a></h4>
            </div>
            <div class="two columns">
        ...
        <div class="row">
            <div class="twelve columns" style="background-color: black;">
                <img src="./images/mbg.png" alt="" id="lmbg">
                <h2 style="text-align: center; color:crimson;">Mountains</h2>
            </div>
        </div>
        <?php
            $file = simplexml_load_file("Danao-Jimenez-Zoleta_IT2E_Baguio.xml");

            foreach($file->mountains->mountain as $m){
                echo "
                <div class='row cont'>
                <div class='five columns'>
                    <img src='$m->image' class='fimage'>
                </div>
